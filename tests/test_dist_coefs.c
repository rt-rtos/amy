...
int main(void) {
    ...
    const char *direct[] = {"v0w3f110l1C1,16,1U4Z"};
    const char *via_vel[] = {"v0w3f110l1C1,16,1U1,,2Z"};
    ...
    const char *via_vel_1oct[] = {"v0w3f110l1C1,16,1U1,,1Z"};
    ...
    const char *mix_zero[] = {"v0w3f110l1C1,16,1U8W0Z"};
    ...
    const char *mix_one[] = {"v0w3f110l1C1,16,1U8W1Z"};
